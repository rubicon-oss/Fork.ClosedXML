    ...
    public class MathTrigTests
    {
        ...
        public void SumProduct()
        {
            using (var wb = new XLWorkbook())
            {
                ...
                Assert.AreEqual(2, ws.Evaluate(true, "SUMPRODUCT(A2)"));
                Assert.AreEqual(55, ws.Evaluate(true, "SUMPRODUCT(A1:A10)"));
                Assert.AreEqual(220, ws.Evaluate(true, "SUMPRODUCT(A1:A10, B1:B10)"));

                Assert.Throws<NoValueAvailableException>(() => ws.Evaluate(true, "SUMPRODUCT(A1:A10, B1:B5)"));
            }
        }
